      ...
      <ErrorBoundary>
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          >
            ...
            <div className="flex-1 space-y-1">
              ...
              <p className="text-sm text-slate-500">
                社区成员 / 唯一 ID: <span className="font-mono text-xs">{user?.id.substring(0, 8)}...</span>
              </p>
              <div className="flex items-center gap-2 pt-2">
                 <div className="bg-yellow-100 text-yellow-800 text-xs font-bold px-3 py-1 rounded-full">Lv.1 新秀艺术家</div>
          ...
          >
            ...
            <Card id="honor-certificate" className="border-none shadow-2xl rounded-none overflow-hidden bg-white">
              ...
              <CardContent className="relative p-12 sm:p-16 text-center space-y-10">
                ...
                <div className="space-y-2">
                  <h3 className="text-sm font-bold uppercase tracking-[0.3em] text-slate-400">数字艺术认证</h3>
                ...
                <div className="space-y-5 max-w-lg mx-auto">
                  <p className="text-slate-600 leading-relaxed">
                    鉴于艺术家 <span className="font-bold text-slate-900 decoration-slate-300 underline underline-offset-4">{user?.name}</span> 的出色创意，
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    其精心创作的作品
                  </p>
                  <h2 className="text-3xl font-light italic text-slate-800 tracking-tight">《{mockLatestPhoto.title}》</h2>
                  <p className="text-slate-600 leading-relaxed">
                    已成功通过社区评审，并正式录入<span className="font-semibold text-slate-800">社区数字艺术画廊</span>进行永久展示。该作品展示了极高的艺术水准与独特视角，特颁此证，以兹鼓励。
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 items-end w-full pt-16 gap-8 text-left border-t border-slate-100">
                  ...
                  <div className="space-y-2 flex flex-col items-center">
                    ...
                    <span className="text-xs font-medium text-slate-600">{mockLatestPhoto.publishDate}</span>
                    <div className="w-20 h-px bg-slate-200" />
                    <span className="text-[10px] text-slate-400 uppercase tracking-wider">Date of Issue</span>
                  </div>
                  ...
                  <div className="relative flex flex-col items-center group">
                    <div className="p-1 bg-white rounded-full ring-8 ring-green-50 shadow-inner overflow-hidden mb-1 w-20 h-20">
                      <img src={avatarUrl} alt="Seal" className="w-full h-full rounded-full object-cover" />
                    </div>
                    {/* 印章上的文字圈 (可选，增加高级感) */}
                    ...
                    <span className="text-[10px] font-bold text-green-700 uppercase tracking-wider">Verfied Artist Seal</span>
                  </div>
                  ...
                  <div className="space-y-2 flex flex-col items-center">
                    ...
                    <div className="w-20 h-px bg-slate-200" />
                    <span className="text-[10px] text-slate-400 uppercase tracking-wider">Certificate ID</span>
                  </div>
          ...
          <div className="border-t border-slate-100 pt-10 mt-10">
              ...
              <div className="grid grid-cols-4 sm:grid-cols-6 gap-4">
                  {[1,2,3,4].map(b => (
                      <div key={b} className="aspect-square bg-white rounded-xl shadow-sm border border-slate-100 flex flex-col items-center justify-center p-3 text-center">
